			...
			<div class="col-xs-12 col-md-12 col-lg-12">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
                        <form action="{{asset('admin/product/edit/' . $product->prod_id)}}" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group" >
                                        ...
                                        <script type="text/javascript">
                                            var editor = CKEDITOR.replace('description',{
                                                ...
                                                filebrowserFlashUploadUrl: '../../../../../public//public/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash',
                                            });
                                        </script>
									</div>
									<div class="form-group" >
										...
										<select required name="cate" class="form-control">
                                            @foreach ($categories as $cate)
                                                <option value="{{$cate->cate_id}}"
                                                    @if ($cate->cate_id == $product->prod_cate)
                                                        selected
                                                    @endif>
                                                    {{$cate->cate_name}}
                                                </option>
